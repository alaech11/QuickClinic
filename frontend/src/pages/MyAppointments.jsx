    ...
    <div>
      ...
      <div>
        {appointments.map((item,index) => (
          <div className='grid gridclos-[1fr_3fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
            <div>
            ...
            <p className='text-sm mt-1'><span className='text-sm text-neutral-700 font-medium'>Date & Time:</span> {slotDtaeFormat(item.slotDate)} | {item.slotTime}</p>
          </div>
          <div></div>
