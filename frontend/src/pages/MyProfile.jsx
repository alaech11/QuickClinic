      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-nuetral-700'>
          ...
          <p className='font-medium'>Adress:</p>
          {
           isEdit
           ? <p>
            <input  className='bg-gray-100 max-w-52' value={userData.address.line1} onChange={(e) => setUserData(prev => ({...prev,adress:{...prev,adress, line1: e.target.value}}))} type="text" />
            <br />
            <input  className='bg-gray-100 max-w-52' value={userData.address.line2} onChange={(e) => setUserData(prev => ({...prev,adress:{...prev,adress, line2: e.target.value}}))} type="text" />
           </p>
